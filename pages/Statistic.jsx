    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-purple-400">819</h6>
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-purple-400">1.3K</h6>
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-purple-400">91</h6>
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-purple-400">52</h6>
